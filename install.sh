...
#
# This script is intentionally plain POSIX sh — no bashisms — because
# `curl ... | sh` ignores the shebang and dash (Debian/Ubuntu /bin/sh)
# rejects things like `set -o pipefail` and `[[ ... ]]`.
#
# What it does:
